...
export const LiveIcon = ({ width = '3.6rem', height = '3.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
